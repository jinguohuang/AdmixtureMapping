...
plt<-ggplot(data=cverror, aes(x=K, y=cv_error, group=1)) + geom_line() + geom_point()+ xlab("K") + ylab("Cross-validation error") + ggtitle(paste0("Cross validation error in ", Name))
